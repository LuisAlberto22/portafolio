  ...
  <div class="border-b-4 border-matrix-hover pb-12">
      ...
      <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        <div class="sm:col-span-3">
          <label for="first_name" class="block text-2xl text-matrix-700 leading-6 ">Nombres:</label>
          <div class="mt-2">
        ...
        <div class="sm:col-span-3">
          <label for="last_name" class="block text-2xl text-matrix-700  leading-6 ">Apellidos:</label>
          <div class="mt-2">
        ...
        <div class="sm:col-span-6">
          <label for="email" class="block text-2xl text-matrix-700  leading-6 ">Email address:</label>
          <div class="mt-2">
        ...
        <div class="sm:col-span-6">
          <label for="content" class="block text-2xl text-matrix-700  leading-6 ">Contenido:</label>
          <div class="mt-2">
        ...
        <input type="submit" class="bg-matrix-components hover:bg-matrix-hover text-2xl font-bold py-2 px-4 rounded" value="Enviar">
